...
class js_util_ns {
  static T? getProperty<T>(Object o, String name) => js_util.getProperty<T>(o, name);
  static void setProperty(Object o, String name, Object? value) => js_util.setProperty(o, name, value);
  static Object jsify(Object o) => js_util.jsify(o);
  static Future<T> promiseToFuture<T>(Object promise) => js_util.promiseToFuture<T>(promise);
  static bool hasProperty(Object o, Object name) => js_util.hasProperty(o, name);
